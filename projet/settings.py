...
SECRET_KEY = 'django-insecure-%s26ywiqj4h=vmyo(#dx1g4)wz^4ht@a48z!ye^$xokye@#3z5'
...
MIDDLEWARE = [
    ...
    "app_connaissance.middleware.require_password_change_middleware",
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app_connaissance.context_processors.frontend_user',
            ],
        },
    },
]
...
# Redirection après changement de mot de passe (première connexion)
PASSWORD_CHANGE_REDIRECT_URL = "/dashboard/"

# ---------------------------------------------------------------------------
# SMTP – Envoi des emails (identifiants temporaires, reset password)
# En production : définir les variables d'environnement ou un .env
# ---------------------------------------------------------------------------
